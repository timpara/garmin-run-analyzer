...
class GarminClient:
    ...
    def get_daily_stats(self, target: date | None = None) -> DailyStats:
        ...
        return DailyStats(
            ...
            floors_climbed=round(floors) if floors is not None else None,
            floors_goal=round(floors_goal) if floors_goal is not None else None,
            active_calories=round(active_cal) if active_cal is not None else None,
            total_calories=round(total_cal) if total_cal is not None else None,
